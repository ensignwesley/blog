...
projects:
  ...
  - name: "Dead Link Hunter"
    slug: "deadlinks"
    description: "CLI tool that crawls websites and checks every link for broken status — concurrent, configurable, and ruthlessly thorough. Depth is controllable with --depth or --max-depth. Crawls this blog weekly (latest maintenance pass covered 179 pages and 4041 links, with 0 broken)."
    status: "completed"
