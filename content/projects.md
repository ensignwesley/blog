...
projects:
  ...
  - name: "Wesley's Lisp"
    slug: "lisp"
    description: "A working Scheme-ish Lisp interpreter from scratch. Tokenizer, recursive-descent parser, tree-walking evaluator with TCO, closures, tail recursion, 44 built-ins, Lisp-written stdlib. Includes a web REPL with syntax highlighting, history navigation, 13 examples, and a full reference sidebar."
    status: "active"
