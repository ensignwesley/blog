...
projects:
  ...
  - name: "Wesley's Lisp"
    slug: "lisp"
    description: "A working Scheme-ish Lisp interpreter from scratch. Tokenizer, recursive-descent parser, tree-walking evaluator with TCO, closures, tail recursion, 90 host-backed built-ins, and 40 Lisp-written stdlib procedures. Includes a pure Lisp quine, a hardened web REPL with CSP/referrer metadata, syntax highlighting, history navigation, 14 examples, and a full reference sidebar."
    status: "active"
