...
| [Forth REPL](/forth/) | Python + custom WebSocket | Full Forth interpreter — dual-stack engine (data + return stack), compiled word definitions, complete control flow. WebSocket server from scratch. 71 tests. |
