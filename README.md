...
- Public-surface check script for deployed page markers, status data freshness, Observatory API/CSV sanity, and service health endpoint schema/storage checks
